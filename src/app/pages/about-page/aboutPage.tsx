  ...
  return (
    <>
      <div className="flex flex-col items-center gap-10">
        ...
        <div className="grid w-full grid-cols-1 justify-items-center sm:grid-cols-[1fr_10fr]">
          <div className="flex w-[60px] items-center justify-center">
            <h1 className="text-main vertical-header left-0 rotate-0 whitespace-nowrap sm:-rotate-90">About Us</h1>
          </div>
          <Card className="flex flex-col items-center px-5">
            <CardDescription className="text-base md:text-lg">
              Every book has its first chapter, but the real magic begins with the second. At Second Chapter, we believe
              that great stories deserve more than just one reader — they deserve to be shared, rediscovered, and loved
              all over again.
            </CardDescription>
            <CardDescription className="text-base md:text-lg">
            ...
            <CardDescription className="text-base md:text-lg">
              Our team puts love and care into every part of the process — from choosing books to creating a cozy space
              where readers can explore and enjoy. We work so that you can feel the joy of finding something special — a
        ...
        <div className="grid w-full grid-cols-1 justify-items-center sm:grid-cols-[1fr_10fr]">
          <div className="flex w-[60px] items-center justify-center">
            <h1 className="text-main vertical-header rotate-0 whitespace-nowrap sm:-rotate-90">Our Team</h1>
          </div>
        ...
        <Card className="w-[clamp(280px,90vw,800px)]">
          ...
          <CardDescription className="text-base md:text-lg">
            ...
            RSSchool, we not only became confident junior developers but also discovered the joy of working as a real
            team.
          </CardDescription>
          <CardDescription className="text-base md:text-lg">
            Collaborating on this project felt surprisingly easy and inspiring — we always knew we could rely on each
            other’s support, ideas, and care. It wasn’t just about building a product, it was about learning to listen,
            to cooperate, and to grow together.
          </CardDescription>
          <CardDescription className="text-base md:text-lg">
            Thank you,{' '}
            <a
            ...
            , for the knowledge, for the friendships, and for the atmosphere that makes you want to learn, improve, and
            move forward. 💛
          </CardDescription>
