  ...
  return (
    <input
      ...
      className={cn(
        ...
        'read-only:text-md read-only:cursor-text read-only:border-0 read-only:shadow-none read-only:focus:ring-0 read-only:focus:outline-none read-only:focus-visible:ring-offset-0',
        className
      )}
      {...props}
    />
